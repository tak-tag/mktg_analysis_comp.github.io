...
<!-- preamble start -->
    ...
    <script>
      ...
      function styleCell_52ze07oe7tu3whxej1ql(i, j, css_id) {
          var table = document.getElementById("tinytable_52ze07oe7tu3whxej1ql");
      ...
      function spanCell_52ze07oe7tu3whxej1ql(i, j, rowspan, colspan) {
        var table = document.getElementById("tinytable_52ze07oe7tu3whxej1ql");
      ...
      window.addEventListener('load', function () {
          ...
          { positions: [ { i: 7, j: 1 }, { i: 7, j: 2 }, { i: 7, j: 3 },  ], css_id: 'tinytable_css_0xkwfh42tio69t0tnvl0',}, 
          { positions: [ { i: 6, j: 1 }, { i: 6, j: 2 }, { i: 6, j: 3 },  ], css_id: 'tinytable_css_y5lq4vubs2ldltwf3oa1',}, 
          { positions: [ { i: 1, j: 1 }, { i: 2, j: 1 }, { i: 3, j: 1 }, { i: 5, j: 1 }, { i: 2, j: 2 }, { i: 3, j: 2 }, { i: 1, j: 2 }, { i: 2, j: 3 }, { i: 3, j: 3 }, { i: 4, j: 1 }, { i: 5, j: 2 }, { i: 4, j: 2 }, { i: 1, j: 3 }, { i: 4, j: 3 }, { i: 5, j: 3 },  ], css_id: 'tinytable_css_2hgl7no564h2selnv2hd',}, 
          { positions: [ { i: 0, j: 1 }, { i: 0, j: 2 }, { i: 0, j: 3 },  ], css_id: 'tinytable_css_8xkwsyxv1jg4it8tders',}, 
          { positions: [ { i: 7, j: 0 },  ], css_id: 'tinytable_css_ozc9ncnvvk0eivb7l67u',}, 
          { positions: [ { i: 6, j: 0 },  ], css_id: 'tinytable_css_retbep86sg0bhsrn0oi0',}, 
          { positions: [ { i: 1, j: 0 }, { i: 2, j: 0 }, { i: 3, j: 0 }, { i: 4, j: 0 }, { i: 5, j: 0 },  ], css_id: 'tinytable_css_roud730e9awfqpl2ygyy',}, 
          { positions: [ { i: 0, j: 0 },  ], css_id: 'tinytable_css_8ueifgutwzxl3t4xy3gd',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  styleCell_52ze07oe7tu3whxej1ql(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
      ...
      .table td.tinytable_css_0xkwfh42tio69t0tnvl0, .table th.tinytable_css_0xkwfh42tio69t0tnvl0 { text-align: center; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_y5lq4vubs2ldltwf3oa1, .table th.tinytable_css_y5lq4vubs2ldltwf3oa1 { text-align: center; border-bottom: solid black 0.05em; }
      .table td.tinytable_css_2hgl7no564h2selnv2hd, .table th.tinytable_css_2hgl7no564h2selnv2hd { text-align: center; }
      .table td.tinytable_css_8xkwsyxv1jg4it8tders, .table th.tinytable_css_8xkwsyxv1jg4it8tders { text-align: center; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
      .table td.tinytable_css_ozc9ncnvvk0eivb7l67u, .table th.tinytable_css_ozc9ncnvvk0eivb7l67u { text-align: left; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_retbep86sg0bhsrn0oi0, .table th.tinytable_css_retbep86sg0bhsrn0oi0 { text-align: left; border-bottom: solid black 0.05em; }
      .table td.tinytable_css_roud730e9awfqpl2ygyy, .table th.tinytable_css_roud730e9awfqpl2ygyy { text-align: left; }
      .table td.tinytable_css_8ueifgutwzxl3t4xy3gd, .table th.tinytable_css_8ueifgutwzxl3t4xy3gd { text-align: left; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
    </style>
    <div class="container">
      <table class="table table-borderless" id="tinytable_52ze07oe7tu3whxej1ql" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
        <thead>
...
<!-- preamble start -->
    ...
    <script>
      ...
      function styleCell_azaoagra5f3wzrnx11zo(i, j, css_id) {
          var table = document.getElementById("tinytable_azaoagra5f3wzrnx11zo");
          var cell = table.rows[i]?.cells[j];  // Safe navigation to avoid errors
          if (cell) {
              console.log(`Styling cell at (${i}, ${j}) with class ${css_id}`);
              cell.classList.add(css_id);
      ...
      function spanCell_azaoagra5f3wzrnx11zo(i, j, rowspan, colspan) {
        var table = document.getElementById("tinytable_azaoagra5f3wzrnx11zo");
        const targetRow = table.rows[i];
        const targetCell = targetRow.cells[j];
        for (let r = 0; r < rowspan; r++) {
      ...
      window.addEventListener('load', function () {
          var cellsToStyle = [
            // tinytable style arrays after
          { positions: [ { i: 6, j: 1 }, { i: 6, j: 2 },  ], css_id: 'tinytable_css_cskwbn2u6g3ur5nkwatt',}, 
          { positions: [ { i: 4, j: 2 }, { i: 4, j: 1 },  ], css_id: 'tinytable_css_wz4gwo4ip6eyd13h3hhm',}, 
          { positions: [ { i: 1, j: 1 }, { i: 2, j: 1 }, { i: 1, j: 2 }, { i: 5, j: 1 }, { i: 3, j: 2 }, { i: 3, j: 1 }, { i: 5, j: 2 }, { i: 2, j: 2 },  ], css_id: 'tinytable_css_hnbdxk20a646nv45gxqd',}, 
          { positions: [ { i: 0, j: 1 }, { i: 0, j: 2 },  ], css_id: 'tinytable_css_6euvpk8p9dno4cotzc0k',}, 
          { positions: [ { i: 6, j: 0 },  ], css_id: 'tinytable_css_ad6wrxcfcvj45pjl25c5',}, 
          { positions: [ { i: 4, j: 0 },  ], css_id: 'tinytable_css_8n0kz5c3zt028mydtrmd',}, 
          { positions: [ { i: 1, j: 0 }, { i: 2, j: 0 }, { i: 3, j: 0 }, { i: 5, j: 0 },  ], css_id: 'tinytable_css_w2xvihmbzhz53oyzvuxk',}, 
          { positions: [ { i: 0, j: 0 },  ], css_id: 'tinytable_css_y7gk1z0czl3he7xdrpsv',}, 
          ];

          // Loop over the arrays to style the cells
          cellsToStyle.forEach(function (group) {
              group.positions.forEach(function (cell) {
                  styleCell_azaoagra5f3wzrnx11zo(cell.i, cell.j, group.css_id);
              });
          });
      });
    </script>
    ...
    <style>
      /* tinytable css entries after */
      .table td.tinytable_css_cskwbn2u6g3ur5nkwatt, .table th.tinytable_css_cskwbn2u6g3ur5nkwatt { text-align: center; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_wz4gwo4ip6eyd13h3hhm, .table th.tinytable_css_wz4gwo4ip6eyd13h3hhm { text-align: center; border-bottom: solid black 0.05em; }
      .table td.tinytable_css_hnbdxk20a646nv45gxqd, .table th.tinytable_css_hnbdxk20a646nv45gxqd { text-align: center; }
      .table td.tinytable_css_6euvpk8p9dno4cotzc0k, .table th.tinytable_css_6euvpk8p9dno4cotzc0k { text-align: center; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
      .table td.tinytable_css_ad6wrxcfcvj45pjl25c5, .table th.tinytable_css_ad6wrxcfcvj45pjl25c5 { text-align: left; border-bottom: solid #d3d8dc 0.1em; }
      .table td.tinytable_css_8n0kz5c3zt028mydtrmd, .table th.tinytable_css_8n0kz5c3zt028mydtrmd { text-align: left; border-bottom: solid black 0.05em; }
      .table td.tinytable_css_w2xvihmbzhz53oyzvuxk, .table th.tinytable_css_w2xvihmbzhz53oyzvuxk { text-align: left; }
      .table td.tinytable_css_y7gk1z0czl3he7xdrpsv, .table th.tinytable_css_y7gk1z0czl3he7xdrpsv { text-align: left; border-top: solid #d3d8dc 0.1em; border-bottom: solid #d3d8dc 0.05em; }
    </style>
    <div class="container">
      <table class="table table-borderless" id="tinytable_azaoagra5f3wzrnx11zo" style="width: auto; margin-left: auto; margin-right: auto;" data-quarto-disable-processing='true'>
        <thead>
